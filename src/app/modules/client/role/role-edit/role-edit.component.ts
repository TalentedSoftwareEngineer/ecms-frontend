          ...
          .subscribe(guiPermissions => {
            ...
            this.api.getGuiSections()
              .subscribe(guiSections => {
                ...
                this.guiSections.map(guiSection => {
                  ...
                  this.guiVisibilities.map(guiVisibility => {
                    if (guiVisibility.guisectionId === guiSection.id) {guiPermissionId = guiVisibility.guipermissionId}
                  });
